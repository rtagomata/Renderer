...
void RoomMesh::SetMaterial(VECTOR3D ambient, VECTOR3D diffuse, VECTOR3D specular, double shininess)
{
...
bool RoomMesh::InitMesh(int meshSize, VECTOR3D origin, double meshLength, double meshWidth, VECTOR3D dir1, VECTOR3D dir2)
{
	VECTOR3D o;
	int currentVertex = 0;
	double sf1, sf2;
...
void RoomMesh::DrawMesh(int meshSize)
{
	int currentQuad = 0;
